...
async function loginGhost(page, link) {
  ...
  await page.type('#blog-title', 'Monkey Test Title');
  await page.type('#name', 'Monkey Test Name');
  await page.type('#email', 'equipo3@monkeytest.com');
  await page.type('#password', 'ihEHubpNSTpUQS4#123');
